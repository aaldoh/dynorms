...
knitr::opts_chunk$set(echo=F, warning = F, message = F, results = "asis", fig.path = "figure/")
...
```{r h2-percept-table}
kable(ls_change$table, caption = "Perception change contrasts", escape = F, row.names = F) %>%
  kable_styling()
```
...
kable(ls_preconformity$table, caption = "Preconformity contrasts", escape = F, row.names= F) %>%
  kable_styling()
```
