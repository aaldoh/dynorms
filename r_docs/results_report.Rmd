...
```{r h4-trace, fig.show='asis', fig.cap="Traceplots for estimated regression parameters"}
...
```{r h4-density, fig.show='asis', fig.cap="Posterior density plot"}
h4_density.plot
```
...
h4.table %>% 
  ...
  footnote(general_title = "Note.",
           ...
           alphabet = c(paste0("ppp = ", printp(h4.global[[1]][["ppp"]])), 
                        ...
                        paste0("ppp = ", printp(h4.global[[3]][["ppp"]]))), footnote_as_chunk = T) %>%
  landscape()
```
...
```{r h5-trace, fig.show='asis', fig.cap="Traceplots of regression parameters"}
...
interact.table %>% 
  ...
  footnote(general_title = "Note.",
           ...
           alphabet = c(paste0("ppp = ", printp(h5.global[[1]][["ppp"]])), 
                        ...
                        paste0("ppp = ", printp(h5.global[[3]][["ppp"]]))),
           footnote_as_chunk = T) %>%
  landscape()
```
