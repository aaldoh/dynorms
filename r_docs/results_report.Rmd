...
## 3. Does dynamic norm (versus static or no norm) information increase participants’ positive attitude, intentions, and expectations to reduce their meat consumption? {.tabset .tabset-pills} $\sigma$
...
```{r, fig.show='asis', fig.cap="Influence of priors on posterior regression estimates"}
ggarrange(plotlist = h3.plots, common.legend = TRUE, legend = "right", labels = c("A", "B", "C"))
```
